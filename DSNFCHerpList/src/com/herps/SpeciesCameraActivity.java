...
public class SpeciesCameraActivity extends Activity implements OnClickListener, PictureCallback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(b.getParcelable("com.herps.HerpDetails") != null){
		 	selectedOrganism =b.getParcelable("com.herps.HerpDetails");
		}	
		setContentView(R.layout.species_camera);
	...
	public void onPictureTaken(byte[] data, Camera camera) {
		...
		try {
			...
			selectedOrganism.setImageName(selectedOrganism.getGenus() + System.currentTimeMillis()+".jpg");
			...
			Intent intent = new Intent(getParent(),FinalSpeciesObserveDetails.class);
			...
			intent.setData(configPath);
    		 View newView = TaxActivityGroup.species.getLocalActivityManager()
              .startActivity("FinalSpeciesObserveDetails", intent
